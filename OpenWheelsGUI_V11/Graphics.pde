...
void   viewError()
{
  ...
  if (error.charAt(8) == '0')   errorMessage += "StandBy  "; 
  if (error.charAt(8) == '1')   errorMessage += "GO  ";
  if (error.charAt(7) == '1')   errorMessage += "VBat_under  ";
  if (error.charAt(6) == '1')   errorMessage += "VBat_over  ";
  if (error.charAt(5) == '1')   errorMessage += "IBat_over  ";
  if (error.charAt(4) == '1')   errorMessage += "Steer_error  ";
  if (error.charAt(3) == '1')   errorMessage += "Acc_error  ";
  if (error.charAt(2) == '1')   errorMessage += "Gyro_error  ";
  if (error.charAt(1) == '1')   errorMessage += "Angle_error  ";
  if (error.charAt(0) == '1')   errorMessage += "EEPROM_error  ";
