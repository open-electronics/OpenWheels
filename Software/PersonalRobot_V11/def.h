// OpenwheelsV2.0 definition

#define SERIAL_COM_SPEED 115200
#define LCD_COM_SPEED 9600

//Set UART for communication
//#define GUI Serial  // telemetry USB cable
#define GUI Serial3 // telemetry wireless Xbee or BT
#define LCD Serial1  // used for LCD message

//ADC Inputs
#define Steer_ADC_pin  0
#define VBat_ADC_pin   1
#define IBat_ADC_pin   2
#define Acc_ADC_pin    4  //only for analog IMU
#define Gyro_ADC_pin   5  //only for analog IMU
...
#define test_LED_Pin   4   // TP1=D4 (PORTG5) Use to test
#define status_LED_pin 13  // status LED monitor
...
// Encoders (don't modify pin!)
#define encoderLeftPinA 2  // interrupt 0 (ENC1 on board)
#define encoderLeftPinB 49  // PORTL.0 
#define encoderRightPinA 3 // interrupt 1 (ENC2 on board)
#define encoderRightPinB 48 // PORTL.1
volatile long int encoderCounterLeft=0;
volatile long int encoderCounterRight=0;
long int encoderPos;
long int encoderPosPre=0;
long int encoderDif;
float wheelsPos=0;
float wheelsVel=0;
